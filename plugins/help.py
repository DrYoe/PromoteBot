        ...
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   ...
                   text="Sorry Sir, You are Banned to use me. Contact my [Request Group](https://t.me/+XTScHquCH0A0ZTQ1).",
                   parse_mode="markdown",
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                           InlineKeyboardButton("Main Channel Link", url="https://t.me/YNmovieone"),
                           InlineKeyboardButton("Request Group", url="https://t.me/+XTScHquCH0A0ZTQ1")
                      ],
                     [
                           InlineKeyboardButton("🧑‍💻Devloper🧑‍💻", url="https://t.me/YoeNaung")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
async def _help(client, message):
    ...
    if update_channel:
        try:
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Request Group](https://t.me/+XTScHquCH0A0ZTQ1).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
